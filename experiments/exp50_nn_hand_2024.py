...
def main():
    ...
    pd.concat(parts,ignore_index=True).to_csv(RES/"exp50_nn_hand_2024_oof.csv.gz",index=False,compression="gzip")
    pd.DataFrame(rows).to_csv(RES/"exp50_nn_hand.csv",index=False,encoding="utf-8-sig")
