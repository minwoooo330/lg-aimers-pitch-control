# -*- coding: utf-8 -*-
"""실험 50: 투수 임베딩을 동손/반대손 2벌로 분리 (투수x동손 신호 0.0392 겨냥). 2024 화면."""
...
def main():
    ...
    pd.concat(parts,ignore_index=True).to_csv(RES/"exp51_nn_hand_2223_oof.csv.gz",index=False,compression="gzip")
    pd.DataFrame(rows).to_csv(RES/"exp51_nn_hand_2223.csv",index=False,encoding="utf-8-sig")
