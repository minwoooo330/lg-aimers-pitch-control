...
def main():
    ...
    pd.concat(parts,ignore_index=True).to_csv(RES/"exp54_nn_cnt_2223_oof.csv.gz",index=False,compression="gzip")
    pd.DataFrame(rows).to_csv(RES/"exp54_nn_cnt_2223.csv",index=False,encoding="utf-8-sig")
