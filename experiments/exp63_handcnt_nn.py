# -*- coding: utf-8 -*-
"""실험 63: 투수 임베딩을 (타자손잡이 2) x (카운트 우열 3) = 6벌로 분리한 NN, 시드 3개, 3-fold.
...
def main():
    ...
    for year in [2022,2023,2024]:
        ...
        pd.DataFrame(rows).to_csv(RES/"exp63_handcnt.csv",index=False,encoding="utf-8-sig")
    pd.concat(parts,ignore_index=True).to_csv(RES/"exp63_handcnt_oof.csv.gz",index=False,compression="gzip")
