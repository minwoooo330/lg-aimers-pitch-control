# -*- coding: utf-8 -*-
"""실험 74: 손잡이 분리 NN 2에폭 검증 (현행 4에폭 과학습 가설, exp35 에폭 곡선 근거)."""
...
def main():
    ...
    for year in [2022,2023,2024]:
        ...
        pd.concat(parts,ignore_index=True).to_csv(RES/"exp74_hand_ep2_oof.csv.gz",index=False,compression="gzip")
        pd.DataFrame(rows).to_csv(RES/"exp74_hand_ep2.csv",index=False,encoding="utf-8-sig")
