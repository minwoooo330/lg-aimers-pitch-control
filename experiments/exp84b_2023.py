...
def main():
    ...
    for year in [2023]:
        ...
        pd.concat(parts,ignore_index=True).to_csv(RES/"exp84b_2023_oof.csv.gz",index=False,compression="gzip")
        pd.DataFrame(rows).to_csv(RES/"exp84b_2023.csv",index=False,encoding="utf-8-sig")
