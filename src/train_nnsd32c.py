# -*- coding: utf-8 -*-
"""nnsd 추가 16시드 (기존 16시드와 합쳐 32시드 평균용)."""
"""nnsd 추가 시드 8개(전체 데이터). 기존 8시드 pkl과 합쳐 16시드로 쓴다."""
...
DATA=HERE/"data"/"train.csv"; OUT=HERE/"submits_common"; PKL=OUT/"nnsd32c_model.pkl"
...
EPOCHS=4; BATCH=8192; SEEDS=[101,202,303,404,505,606,707,808,909,1111,1212,1313,1414,1515,1616,1717]
