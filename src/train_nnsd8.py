# -*- coding: utf-8 -*-
"""train_nnsd8 — nnsd(챔피언 최대 성분 45%)를 8시드 평균으로 재학습.
   근거(exp133): 8시드 단독 2024 0.24750917 / 2022 0.24810325 (3시드 0.24760694 / 0.24816873).
   챔피언의 nnsd 성분만 교체 시 체인 2024 +1.74 / 2022 +1.39.
   시드 평균은 역대 '추가·평균형'으로 분류되며 hand3(+8.58), hand8pb(+10.29) 등 성공 이력이 있다."""
...
DATA=HERE/"data"/"train.csv"; OUT=HERE/"submits_common"; PKL=OUT/"nnsd8_model.pkl"
...
EPOCHS=4; BATCH=8192; SEEDS=[42,7,2024,1,13,77,101,777]
