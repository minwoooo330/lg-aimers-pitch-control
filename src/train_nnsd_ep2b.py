# -*- coding: utf-8 -*-
"""2에폭 nnsd 전체데이터 학습 (전반 8시드). exp153/154에서 확인된 과적합 교정."""
...
DATA=HERE/"data"/"train.csv"; OUT=HERE/"submits_common"; PKL=OUT/"nnsd_ep2_b_model.pkl"
...
EPOCHS=2; BATCH=8192; SEEDS=[3,21,55,90,123,256,512,999]
