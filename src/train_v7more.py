# -*- coding: utf-8 -*-
"""v7 추가 시드 6개(전체 데이터). 기존 v7bundle의 3시드와 합쳐 9시드로 쓴다.
   순수 분산 감소이며 배포 테이블(carry/marcel/platoon/trackman)은 기존 것을 재사용한다."""
...
HERE=Path(__file__).resolve().parent; OUT=HERE/"v7bundle_more"
...
L2,RSM=1000.0,0.6; SEEDS=[1,13,77,101,777,3]; MIN_SEASON=2020; TARGET_YEAR=2025
